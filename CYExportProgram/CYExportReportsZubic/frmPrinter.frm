...
Private Sub Form_Load()
    ...
    Next Pr
    If ref = 0 Then
        MsgBox " There are no DEFAULT PRINTER available," & _
                        " create a Default Printer to continue . . . ", vbCritical + vbOKOnly, "Printer Error"
    Else
