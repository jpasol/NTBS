...
On Error GoTo err
If gcnnBilling.State = adStateOpen Then gcnnBilling.Close
If gcnnNavis.State = adStateOpen Then gcnnNavis.Close

gcnnBilling.Open
gcnnNavis.Open

gcnnBilling.BeginTrans
gcnnNavis.BeginTrans
            ...
            If SaveDetails Then
                If SaveHeaders Then
                    ...
                    If intResponse = vbOK Then
                        Call PrintGatePass
                    End If
                    gcnnBilling.CommitTrans
                    gcnnNavis.CommitTrans
...
err:
  ...
  gcnnBilling.RollbackTrans
  gcnnNavis.RollbackTrans
  'Call WriteLogError
End Sub
...
updateQuery:
            ...
            updateQuery = "INSERT INTO CYMGps (refnum,seqnum,gpsnum,gpstyp,cntnum,enttyp,entnum,voyageno,location,sbmapn,custompn," & _
                ...
                updateQuery2 = updateQuery2 & "'" & MoveToField(Column.Commodity, "C") & "'," 'commod
...
'                Call Update_Manifest(Trim(txtBL.Text), Trim(MoveToField(Column.ContainerID, "C")), Trim(lngGPSNum))
    ...
    Exit Function
ErrSaveDetails:
MsgBox "Error writing in detail..." & vbNewLine & _
                    "Error: " & err.Number & _
                    err.Description, vbExclamation + vbDefaultButton2 + vbOKOnly, "Error!"
...
If cmbConNo.Text = EvalContainer Then
Exit Sub
End If
