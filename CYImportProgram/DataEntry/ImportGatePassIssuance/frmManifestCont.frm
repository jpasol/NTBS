...
Begin VB.Form frmManifestCont 
   ...
   Begin TabDlg.SSTab sstMain 
      ...
      Begin VB.CommandButton cmdNextHeader 
         ...
         Height          =   400
         Left            =   -62880
         Picture         =   "frmManifestCont.frx":00B6
         TabIndex        =   21
         Top             =   9960
         Width           =   2655
      End
      ...
      Begin VB.ComboBox cboUnderGuarantee 
         ...
         EndProperty
         Height          =   405
         ItemData        =   "frmManifestCont.frx":0980
         Left            =   -71280
         List            =   "frmManifestCont.frx":0982
         Style           =   2  'Dropdown List
         TabIndex        =   13
         Top             =   4200
         Width           =   5655
      ...
      Begin VB.CommandButton cmdNextBL 
         ...
         Height          =   400
         Left            =   -62520
         Picture         =   "frmManifestCont.frx":0988
         TabIndex        =   0
         Top             =   9900
         Width           =   2295
      End
...
'Call Update_Manifest(Trim(txtBL.Text), Trim(cmbConNo.Text), Trim(456))
...
Private Sub SaveHeaders()
    On Error GoTo ErrSaveHeaders
        txtLog.Text = txtLog.Text & "SaveHeaders: Start Sub" & vbCrLf
        dtmSystemDateTime = gzGetSysDate
        txtLog.Text = txtLog.Text & "SaveHeaders: dtmSystemDateTime = gzGetSysDate" & vbCrLf
        Set rstCYMPay = New ADODB.Recordset
        txtLog.Text = txtLog.Text & "SaveHeaders: Set rstCYMPay = New ADODB.Recordset" & vbCrLf
        With rstCYMPay
        txtLog.Text = txtLog.Text & "SaveHeaders: With rstCYMPay" & vbCrLf
            .LockType = adLockOptimistic
            txtLog.Text = txtLog.Text & "SaveHeaders: .LockType = adLockOptimistic" & vbCrLf
            .CursorType = adOpenDynamic
            txtLog.Text = txtLog.Text & "SaveHeaders: .CursorType = adOpenDynamic" & vbCrLf
            .Open "CYMPAY", gcnnBilling, , , adCmdTable
            txtLog.Text = txtLog.Text & "SaveHeaders: .Open ""CYMPAY"", gcnnBilling, , , adCmdTable" & vbCrLf
            
            .AddNew
            txtLog.Text = txtLog.Text & "SaveHeaders: .AddNew" & vbCrLf
            .Fields("Refnum") = lngReferenceNo
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""Refnum"") = lngReferenceNo" & vbCrLf
            .Fields("cuscde") = "" & Trim(txtCustomerCode)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""cuscde"") = """" & Trim(txtCustomerCode)" & vbCrLf
            If txtCustomerName = "" Then
            txtLog.Text = txtLog.Text & "SaveHeaders: If txtCustomerName = """" Then" & vbCrLf
                .Fields("cusnam") = "" & Trim(txtCustomer)
                txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""cusnam"") = """" & Trim(txtCustomer)" & vbCrLf
            Else
            txtLog.Text = txtLog.Text & "SaveHeaders:  Else" & vbCrLf
                .Fields("cusnam") = "" & Trim(txtCustomerName)
                txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""cusnam"") = """" & Trim(txtCustomerName)" & vbCrLf
            End If
            txtLog.Text = txtLog.Text & "SaveHeaders: End If" & vbCrLf
            .Fields("phpamt") = curPHPAmount
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""phpamt"") = curPHPAmount" & vbCrLf
            .Fields("cshamt") = mskCashAmount
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""cshamt"") = mskCashAmount" & vbCrLf
            .Fields("adramt") = mskADRAmount
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""adramt"") = mskADRAmount" & vbCrLf
            .Fields("adrnum") = lngControlNo
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""adrnum"") = lngControlNo" & vbCrLf
            .Fields("chgamt") = mskChange
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chgamt"") = mskChange" & vbCrLf
            .Fields("trntype") = txtTransactionType
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""trntype"") = txtTransactionType" & vbCrLf
            .Fields("chkno1") = "" & mskCheckNo(0)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkno1"") = """" & mskCheckNo(0)" & vbCrLf
            .Fields("chkno2") = "" & mskCheckNo(1)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkno2"") = """" & mskCheckNo(1)" & vbCrLf
            .Fields("chkno3") = "" & mskCheckNo(2)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkno3"") = """" & mskCheckNo(2)" & vbCrLf
            .Fields("chkno4") = "" & mskCheckNo(3)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkno4"") = """" & mskCheckNo(3)" & vbCrLf
            .Fields("chkno5") = "" & mskCheckNo(4)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkno5"") = """" & mskCheckNo(4)" & vbCrLf
            .Fields("chkamt1") = mskCheckAmount(0)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkamt1"") = mskCheckAmount(0)" & vbCrLf
            .Fields("chkamt2") = mskCheckAmount(1)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkamt2"") = mskCheckAmount(1)" & vbCrLf
            .Fields("chkamt3") = mskCheckAmount(2)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkamt3"") = mskCheckAmount(2)" & vbCrLf
            .Fields("chkamt4") = mskCheckAmount(3)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkamt4"") = mskCheckAmount(3)" & vbCrLf
            .Fields("chkamt5") = mskCheckAmount(4)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkamt5"") = mskCheckAmount(4)" & vbCrLf
            .Fields("chkbnk1") = "" & txtBank(0)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkbnk1"") = """" & txtBank(0)" & vbCrLf
            .Fields("chkbnk2") = "" & txtBank(1)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkbnk2"") = """" & txtBank(1)" & vbCrLf
            .Fields("chkbnk3") = "" & txtBank(2)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkbnk3"") = """" & txtBank(2)" & vbCrLf
            .Fields("chkbnk4") = "" & txtBank(3)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkbnk4"") = """" & txtBank(3)" & vbCrLf
            .Fields("chkbnk5") = "" & txtBank(4)
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""chkbnk5"") = """" & txtBank(4)" & vbCrLf
            .Fields("status") = cStatus
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""status"") = cStatus" & vbCrLf
            .Fields("rectag") = ""
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""rectag"") = """"" & vbCrLf
            .Fields("userid") = UCase(zCurrentUser())
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""userid"") = UCase(zCurrentUser())" & vbCrLf
            .Fields("sysdttm") = dtmSystemDateTime
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""sysdttm"") = dtmSystemDateTime" & vbCrLf
            .Fields("updcde") = cUpdateCode
            txtLog.Text = txtLog.Text & "SaveHeaders: .Fields(""updcde"") = cUpdateCode" & vbCrLf
            .Update
            txtLog.Text = txtLog.Text & "SaveHeaders: .Update" & vbCrLf
            .Close
            txtLog.Text = txtLog.Text & "SaveHeaders: .Close" & vbCrLf
        End With
        txtLog.Text = txtLog.Text & "SaveHeaders: End With" & vbCrLf
    On Error GoTo 0
...
Private Sub Update_Manifest(ByVal strBillNo As String, ByVal strConNo As String, ByVal strGpsNum As String)
    If Up_Manifest(strBillNo, strConNo, strGpsNum) = False Then
...
Private Sub Retrieve_ManifestData(ByVal strBillNo As String)
    ...
    With rstManifest
        ...
        txtVesselCode.Text = Trim(.Fields("vslname"))
